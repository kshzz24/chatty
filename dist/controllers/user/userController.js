...
export const getAllUsers = async (req, res, next) => {
    ...
    const remainingUsers = currentUserContactList?.contacts.filter((contact) => !allUsersIds.includes(contact.toString()));
...
export const getAllContactsDetails = async (req, res) => {
    const currentUserId = req.user.id;
...
export const allCurrentInvites = async (req, res, next) => {
    try {
        const currentUserId = req.user.id;
